...
1.2           & Gehäuse                                                               & Am Gehäuse wird möglichst wenig verändert                                                                                                            \\ \hline
2.            & \textbf{Audio-Signal}                                                 &                                                                                                                                                      \\ \hline
2.1           & Leistung                                                              & \begin{tabular}[c]{@{}c@{}}Maximale Leistung RMS am\\  Knochenschallaktor 214,5 mW\end{tabular}                                                            \\ \hline
...
5.1           & Laufzeit                                                             & 1 Arbeitstag unter max. Belastung                                                                                                                                               \\ \hline
...
1.            & Daten-Austausch                                                       & \begin{tabular}[c]{@{}c@{}}Bluetooth-Funktionserweiterung um Daten in Dojos\\   Speicher zu laden/löschen mit einer Geschwindigkeit von 1 Mbps\end{tabular}                               \\ \hline
2.            & Lokalisation Dojo                                                     & Sendender Dojo-ID auf Anfrage (via Bluetooth)                                                                                                        \\ \hline
1.            & \begin{tabular}[c]{@{}c@{}}Berechtigung \\ Raumzutritt\end{tabular}   & \begin{tabular}[c]{@{}c@{}}Möglichkeit der Raumauswahl\\   durch Aktivieren/Deaktivieren von Beacon-Gruppen \end{tabular}                               \\ \hline
\end{tabular}
